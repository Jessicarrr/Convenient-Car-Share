...
function initMap() {
    ...
    for (let [key, value] of spotsAndCars) {
        ...
        var carAddress = new XMLHttpRequest();
        var lagtlngAPI = "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + parkingArea.get("Latitude") + "," + parkingArea.get("Longitude") + "&key=AIzaSyB254SclooE0FmuhmjUf6dS_BTrp3zr5Zw";
        carAddress.open("GET", lagtlngAPI, false);
        carAddress.send(null);
        var ca = JSON.parse(carAddress.response);
        ...
        var infoWindow = new google.maps.InfoWindow(
            {
                ...
                content: '<div class="mapInfoWindow">' + '<p>' + ca.results[0].formatted_address + '</p>' + '<div class="alert alert-success">' + wordCar + 'in current parking' +
